...
namespace SharpFile.Infrastructure {
    public class ChildResourceRetrievers : List<IChildResourceRetriever> {
        ...
        public IEnumerable<IChildResourceRetriever> Filter(FileSystemInfo fsi) {
        ...
        public static bool DefaultCustomMethod(FileSystemInfo fsi) {
            return true;
        }
        ...
        public static bool IsFileWithExtension(FileSystemInfo fsi, List<string> extensions) {
            if (extensions != null) {
        ...
        public static bool IsCompressedFile(FileSystemInfo fsi) {
        ...
        /// <param name="fsi">File system object.</param>
        /// <returns>Whether or not the file system object is compressed.</returns>
        public static bool IsCompressedFileThorough(FileSystemInfo fsi) {
            if (fsi is FileInfo) {
                try {
        ...
        public static bool IsMediaFile(FileSystemInfo fsi) {
            if (fsi is FileInfo) {
