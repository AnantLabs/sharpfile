	...
	public class ImageListDrag : IDisposable {
		...
		*/
		...
		public ImageList.ImageCollection Images {
			get {
				return this.iml.Images;
			}
		}

		public Size ImageSize {
			get {
				return this.iml.ImageSize;
			}
			set {
				this.iml.ImageSize = value;
			}
		}

		public ColorDepth ColorDepth {
			get {
				return this.iml.ColorDepth;
			}
			set {
				this.iml.ColorDepth = value;
			}
		}

		public Color TransparentColor {
			get {
				return this.iml.TransparentColor;
			}
			set {
				this.iml.TransparentColor = value;
			}
		}
		...
		public void StartDrag(int imageIndex) {
		...
		public void StartDrag(int imageIndex, int xOffset, int yOffset) {
			int res = 0;
			CompleteDrag();
		...
		/// </summary>
		public ImageListDrag(IContainer container) {
			iml = new ImageList(container);
		}
