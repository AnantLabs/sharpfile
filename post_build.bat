...
"%1Tools\7z.exe" u -tzip -mx9 "%2SharpFile_bin.zip" "%2ChangeLog.txt" "%2SharpFile.exe" "%2gpl.txt" "%2Readme.txt" "%2thanks.txt" "%2ICSharpCode.SharpZipLib.dll" "%2Common.dll" "%2WeifenLuo.WinFormsUI.Docking.dll"
